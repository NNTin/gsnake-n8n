...
Event received -> log data (payload, origin, time) to .tmp/n8n-endpoint/<endpointname>-yyyy-mm-dd-HH-MM-SS.txt
condition check: allowed are manual (localhost) and valid X-Hub-Signature-256

trigger Discord notification, env DISCORD_WEBHOOKURL required.