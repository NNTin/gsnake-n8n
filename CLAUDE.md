...
| `workflows/n8n-workflow/ralph-loop.md` | `tools/n8n-flows/ralph-loop.json` + `tools/scripts/ralph-bridge.js` + `tools/scripts/ralph-bridge.openapi.yaml` | ✅ Implemented |
